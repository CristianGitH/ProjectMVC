...
namespace ProjectMVC.Controllers
{
    public class ActivitiesAPIController : Controller
    {
        ...
        {
            HttpContent content = new StringContent(JsonConvert.SerializeObject(string.Empty),
            ...
            var result = await restClient.RequestAPI<List<Logica.Models.DB.Activities>>("http://localhost/ProjectMVC.API",
                "api/Activities/GetActivities", content, Logica.Services.RestClient.Method.Get);

            var listActivities = new List<Logica.Models.ViewModels.ActivitiesViewModel>();
