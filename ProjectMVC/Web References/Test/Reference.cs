...
namespace ProjectMVC.Test {
    ...
    public partial class Test : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetParcialsOperationCompleted;
        ...
        /// <remarks/>
        public event GetParcialsCompletedEventHandler GetParcialsCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetParcials", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public Parcial[] GetParcials() {
            object[] results = this.Invoke("GetParcials", new object[0]);
            return ((Parcial[])(results[0]));
        }
        
        /// <remarks/>
        public void GetParcialsAsync() {
            this.GetParcialsAsync(null);
        }
        
        /// <remarks/>
        public void GetParcialsAsync(object userState) {
            if ((this.GetParcialsOperationCompleted == null)) {
                this.GetParcialsOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetParcialsOperationCompleted);
            }
            this.InvokeAsync("GetParcials", new object[0], this.GetParcialsOperationCompleted, userState);
        }
        
        private void OnGetParcialsOperationCompleted(object arg) {
            if ((this.GetParcialsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetParcialsCompleted(this, new GetParcialsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    public partial class Parcial {
        ...
        private string name_TeamField;
        
        private int pointsField;
        
        private int matchesPlayField;
        
        private int goalsFavorField;
        
        private int goalsAgainsField;
        ...
        public string Name_Team {
            get {
                return this.name_TeamField;
            }
            set {
                this.name_TeamField = value;
            }
        }
        ...
        public int MatchesPlay {
            get {
                return this.matchesPlayField;
            }
            set {
                this.matchesPlayField = value;
            }
        }
        
        /// <remarks/>
        public int GoalsFavor {
            get {
                return this.goalsFavorField;
            }
            set {
                this.goalsFavorField = value;
            }
        }
        
        /// <remarks/>
        public int GoalsAgains {
            get {
                return this.goalsAgainsField;
            }
            set {
                this.goalsAgainsField = value;
            }
        }
    }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0")]
    public delegate void GetParcialsCompletedEventHandler(object sender, GetParcialsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetParcialsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetParcialsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public Parcial[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((Parcial[])(this.results[0]));
            }
        }
    }
}
